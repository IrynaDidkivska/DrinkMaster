...
export const getAllDrinksThunk = createAsyncThunk('drinks/getAll', async ({ page }, thunkAPI) => {
	try {
...
export const getAllSearchThunk = createAsyncThunk(
	'drinks/getAllSearch',
	async ({ ingredient = '', category = '', query = '', page = 1, limit = 0 }, thunkAPI) => {
		try {
...
export const getOwnThunk = createAsyncThunk('drinks/getOwn', async (_, thunkAPI) => {
	try {
...
//TODO: зробити
export const addOwnDrinkThunk = createAsyncThunk('drinks/addOwnDrink', async (formdata, thunkAPI) => {
	try {
...
export const deleteFromOwnThunk = createAsyncThunk('drinks/deleteFromOwn', async (id, thunkAPI) => {
	try {
...
export const getFavoriteThunk = createAsyncThunk('drinks/getFav', async (_, thunkAPI) => {
	try {
...
export const addFavoriteThunk = createAsyncThunk('drinks/getFav', async (id, thunkAPI) => {
	try {
